...
//MigrationGroup contains information about device pairs, source and target masking views
type MigrationStorageGroup struct {
...
type CreateMigrationEnv struct {
	RemoteSymmID string `json:"otherArrayId"`
}
